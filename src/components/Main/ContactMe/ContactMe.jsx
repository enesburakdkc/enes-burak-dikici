            ...
            <div className="w-full max-h-[calc(100vh-6rem)] font-light bg-black text-white p-8 box-border rounded-2xl">
                ...
                <div className="formContainer flex flex-row gap-8 justify-between">
                    <form action={"https://formsubmit.co/" + email} method="POST" className="flex flex-col grow gap-4">
                        ...
                        <input type="text" name="name" placeholder="Ad Soyad" required className="py-2 px-4 bg-white text-black rounded-md focus:ring focus:ring-gray-300 focus:outline-none focus:drop-shadow-[0_0_7px_rgba(255,255,255,1)] invalid:ring-red-500 invalid:text-red-500 transition-all hover:drop-shadow-[0_0_7px_rgba(255,255,255,1)]" />
                        <label htmlFor="email" className="mb-[-0.5rem]">E-Posta:</label>
                        <input type="email" name="email" placeholder="ornek@gmail.com" required className="py-2 px-4 bg-white text-black rounded-md focus:ring focus:ring-gray-300 focus:outline-none focus:drop-shadow-[0_0_7px_rgba(255,255,255,1)] invalid:ring-red-500 invalid:text-red-500 transition-all hover:drop-shadow-[0_0_7px_rgba(255,255,255,1)]" />
                        <label htmlFor="message" className="mb-[-0.5rem]">Mesaj:</label>
                        <textarea name="message" placeholder="Mesaj" required className="min-h-28 py-2 px-4 bg-white text-black rounded-md focus:ring focus:ring-gray-300 focus:outline-none focus:drop-shadow-[0_0_7px_rgba(255,255,255,1)] invalid:ring-red-500 invalid:text-red-500 transition-all hover:drop-shadow-[0_0_7px_rgba(255,255,255,1)]" />
                        <button type="submit" className="p-2 mt-2 bg-white text-black font-medium rounded-md focus:ring focus:ring-gray-300 focus:outline-none focus:drop-shadow-[0_0_7px_rgba(255,255,255,1)] transition-all hover:drop-shadow-[0_0_7px_rgba(255,255,255,1)]">GÖNDER</button>
                    </form>
