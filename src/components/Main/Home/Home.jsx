        ...
        <section id="home" className="home flex min-h-[100vh] items-center gap-20 justify-between">
            <div className="homeContent h-96 flex flex-col gap-8 justify-evenly items-start mt-5">
                <div className="flex flex-col gap-5">
                    ...
                    <h2 className="text-xl font-medium"><strong>Web Yazılım Geliştiricisi</strong></h2>
                    <p className="text-xl font-medium"><strong>Frontend</strong> ağırlıklı modern <strong>JavaScript</strong> kütüphaneleri üzerinde uzmanlaşan bir yazılım geliştiricisiyim.</p>
                </div>
