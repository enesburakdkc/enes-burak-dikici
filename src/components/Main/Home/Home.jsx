    ...
    return (
        <section id="home" className="flex min-h-[100vh] items-center gap-20 justify-between">
            <div className="h-96 flex flex-col justify-evenly items-start">
                ...
                <a href="https://wa.me/905379760543" target="_blank" className="bg-black text-xl text-white p-5 mt-8 rounded-xl drop-shadow-lg transition-all hover:scale-105">Contact Me &nbsp;<FontAwesomeIcon icon={faLocationArrow} style={{ scale: '1.5', marginLeft: '0.5rem' }} /></a>
