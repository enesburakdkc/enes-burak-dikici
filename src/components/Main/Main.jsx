...
function Main() {
    ...
    return (
        <main className="w-[65vw] h-[calc(100vh-6rem)] flex pl-[5vw] m-auto items-center gap-20 justify-between">
            <div className="h-96 flex flex-col justify-evenly items-start">
                ...
                <button className="bg-black text-xl text-white p-5 mt-8 rounded-xl shadow-lg transition-all hover:scale-105">Contact Me &nbsp;<FontAwesomeIcon icon={faLocationArrow} style={{ scale: '1.5', marginLeft: '0.5rem' }} /></button>
            </div>
