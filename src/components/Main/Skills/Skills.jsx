...
function Skills() {
    ...
    return (
        <section id="skills" className="h-[calc(100vh-6rem)] flex flex-row gap-12 justify-between items-center font-light text-white">
            <div className="h-[20.5rem] bg-black p-8 rounded-2xl">
            ...
            <ul className="grid grid-cols-2 gap-20 text-black py-8 px-12 place-items-center">
